...
export function OfficeLayoutView({ locations = MOCK_LOCATIONS, onMoveLocation, onSelectLocation, onAddLocation, onOpenLocation, onStartScan }) {
    ...
    return (
      <div className="ol">
        <div className="ol-head">
          <div>
            <h1 className="ol-title">Office layout</h1>
            <p className="ol-lede">Loading practice locations…</p>
          </div>
        </div>
        <div className="ol-state">Loading office layout…</div>
      </div>
    );
  }
    ...
    return (
      <div className="ol">
        <div className="ol-head">
          <div>
            <h1 className="ol-title">Office layout</h1>
            <p className="ol-lede">{error}</p>
          </div>
        </div>
        <div className="ol-state">Try again after the locations API is available.</div>
      </div>
    );
  }
  ...
  if (locations.length === 0) {
    return (
      <div className="ol">
        ...
        <div className="ol-state">No locations to place.</div>
      </div>
    );
  }
